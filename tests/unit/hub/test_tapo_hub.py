...
class TestTapoHub:
    ...
    async def test_setup_child_coordinators_should_create_correct_types(self, model: str, expected_type: type):
        with patch("homeassistant.helpers.update_coordinator.DataUpdateCoordinator.async_config_entry_first_refresh"):
            ...
            result = await hub.setup_child_coordinators(hass=self.hass, device_list=[base_child_info],
